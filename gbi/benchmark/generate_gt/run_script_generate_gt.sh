...
python run_generate_gt.py task.name=uniform_1d task.beta=4 
python run_generate_gt.py task.name=two_moons task.beta=10 
python run_generate_gt.py task.name=linear_gaussian task.beta=1
python run_generate_gt.py task.name=gaussian_mixture task.beta=2 
