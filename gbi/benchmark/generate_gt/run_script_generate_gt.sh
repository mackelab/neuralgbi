...
python run_generate_gt.py --multirun hydra/launcher=my_submitit_local task.name=uniform_1d task.beta=4,20,100
python run_generate_gt.py --multirun hydra/launcher=my_submitit_local task.name=two_moons task.beta=10,100,1000
python run_generate_gt.py --multirun hydra/launcher=my_submitit_local task.name=linear_gaussian task.beta=1,10,100
python run_generate_gt.py --multirun hydra/launcher=my_submitit_local task.name=gaussian_mixture task.beta=10,50,250
